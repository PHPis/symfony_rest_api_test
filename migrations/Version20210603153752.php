 ...
 */
final class Version20210603153752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animal (id INT AUTO_INCREMENT NOT NULL, breed_id INT NOT NULL, breeder_id INT NOT NULL, name VARCHAR(255) NOT NULL, birthday DATE NOT NULL, type INT NOT NULL, INDEX IDX_6AAB231FA8B4A30F (breed_id), INDEX IDX_6AAB231F33C95BB1 (breeder_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
